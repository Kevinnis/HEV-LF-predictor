...
if page == "HEV-ALF Predictor":
    ...
    if st.button("Predict HEV-ALF Risk"):
        try:
            ...
            generate_shap_plot(shap_explainer1, feature_values_alf, ["INR", "TBIL", "AST", "HDL", "PLT", "NEU", "TT"], "shap_force_plot_alf.png")
...
# HEV-ACLF Predictor Page
    ...
    if st.button("Predict HEV-ACLF Risk"):
        try:
            ...
            # SHAP explanation
            st.markdown("<h3 style='font-weight: bold;'>Prediction Interpretations</h3>", unsafe_allow_html=True)
            generate_shap_plot(shap_explainer2, feature_values_aclf, ["INR", "TBIL", "Na", "HDL", "URA"], "shap_force_plot_aclf.png")
